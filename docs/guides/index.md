...
2. **[Morphisms & Composition](morphisms.md):** Defines what a morphism is as a tensor in $\mathcal{V}^{|A| \times |B|}$. Covers the morphism hierarchy, composition, and algebraic operations.
