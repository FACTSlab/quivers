...
`algebra product_fuzzy` selects the standard multiplicative composition of probabilities along paths; switching to the [tropical (max-plus) algebra](https://en.wikipedia.org/wiki/Tropical_semiring) reinterprets the same composed morphism as the Viterbi recurrence.
