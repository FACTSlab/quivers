"""Render [`LetExprNode`][quivers.dsl.ast_nodes.LetExprNode] to Julia
tree-sitter schema vertices.

Consumed by the Turing renderer (and any future Julia-grammar renderer).
"""
