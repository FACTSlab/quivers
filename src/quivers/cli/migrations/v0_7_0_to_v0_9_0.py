"""One-hop migrator: v0.7.0 source to v0.9.0 source.

Walks the v0.7.0 parse tree, dispatches per-declaration converters
where the grammar rule shape changed between v0.7.0 and v0.9.0, clones
everything else structurally, and emits canonical v0.9.0 source via
